...
Thumbnailer.prototype.fill = function() {
	var dimensionsString = this.width + 'X' + this.height,
		...
		autoOrient = (this.autoOrient ? '-auto-orient' : ''),
		colorSpace = (this.colorSpace ? '-colorspace ' + this.colorSpace : ''),
		thumbnailCommand = config.get('convertCommand') + ' "' + this.localPaths[0] + '[0]" ' + colorSpace + ' ' + autoOrient + ' -resize ' + dimensionsString + '^ -gravity center -extent ' + dimensionsString + ' ' + qualityString + ' ' + this.convertedPath;
