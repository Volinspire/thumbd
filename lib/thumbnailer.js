...
Thumbnailer.prototype.matted = function() {
	var dimensionsString = this.width + 'X' + this.height,
	  qualityString = (this.quality ? '-quality ' + this.quality : ''),
		...
		thumbnailCommand = config.get('convertCommand') + ' "' + this.localPaths[0] + '[0]" ' + colorSpace + ' ' + autoOrient + ' -resize ' + dimensionsString + ' -size ' + dimensionsString + ' xc:' + this.background + ' -gravity center' + qualityString + ' -composite ' + this.convertedPath;
